    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item active">
                <a href="/auth/index" class="nav-link">Home</a>
            </li>
            <li class="nav-item active">
                <a class="nav-link" href="<?= site_url('/keranjang') ?>">Keranjang <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item active">
                <a class="nav-link" href="<?= site_url('/kopi') ?>">Beli <span class="sr-only">(current)</span></a>
            </li>
        </ul>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                <div class="image">
                    <img src="https://yt3.ggpht.com/a/AATXAJy5pnpZ5d5OyWr5aUD6nXrAhi2WkQVwQ1mYlPWnvw=s900-c-k-c0x00ffffff-no-rj" class="img-circle elevation-2" alt="User Image">
                </div>
                <div class="info">
                    <a href="/auth/index" class="d-block">Vindo RizkiYanto</a>
                </div>
            </div>
